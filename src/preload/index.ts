...
const api = {
    ...
    addImageToExample: async (exampleID: string, path: string): Promise<Image | null> => {
        return await ipcRenderer.invoke(ipcChannels.addImageToExample, exampleID, path)
    },
    deleteImageFromExample: async (exampleID: string, imageID: string): Promise<boolean> => {
        return await ipcRenderer.invoke(ipcChannels.deleteImageFromExample, exampleID, imageID)
    },
    ...
    addExampleToPrompt: async (
        ...
        return await ipcRenderer.invoke(ipcChannels.addExampleToPrompt, promptID, example)
    },
    addExampleIDToPrompt: async (promptID: string, exampleID: string): Promise<Example | null> => {
        return await ipcRenderer.invoke(ipcChannels.addExampleIDToPrompt, promptID, exampleID)
    },
    ...
    deleteExampleIDFromPrompt: async (promptID: string, exampleID: string): Promise<boolean> => {
        return await ipcRenderer.invoke(ipcChannels.deleteExampleIDFromPrompt, promptID, exampleID)
    },
    deleteExampleFromPrompt: async (promptID: string, exampleID: string): Promise<boolean> => {
        return await ipcRenderer.invoke(ipcChannels.deleteExampleFromPrompt, promptID, exampleID)
    },
